        ...
        <>
            ...
            <div className="auth-card">
                <div className="flex flex-column md:flex-row">
                    <div
                        className="w-full md:w-5 flex flex-column align-items-center justify-content-center gap-3 py-3 md:py-5">
                        <div className="field">
                            ...
                            {errors.username && <small
                                className={`p-error ${errors.username ? 'active' : ''}`}>{errors.username}</small>}
                        </div>
                        <div className="field">
                            ...
                            {errors.password && <small
                                className={`p-error ${errors.password ? 'active' : ''}`}>{errors.password}</small>}
                        </div>
                        <Button onClick={handleLogin} label={t('login')} icon="pi pi-user"
                    ...
                    <div className="w-full md:w-5 flex align-items-center justify-content-center py-5">
                        <Button onClick={handleRegister} label={t('register')} icon="pi pi-user-plus" severity="success"
